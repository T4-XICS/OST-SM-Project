...
## Explainability Dashboards (SHAP-Based Feature Importance)

- The explainability module provides real-time feature attribution for each anomaly score generated by the  -LSTM-VAE model.
- A surrogate XGBoost regressor is trained online to approximate the anomaly scoring function, and SHAP values are - computed per window and exported as Prometheus metrics for visualization in Grafana.

1) SHAP Mean Absolute Importance (Batch-Level)

This bar-chart panel shows the average normalised SHAP contribution of each sensor during recent windows.
It highlights which sensors have the strongest influence on the anomaly score.

<p align="center"> <img src="images/explain_shap_mean_abs.png" width="85%"> </p>


2) Top-10 SHAP Features During Anomaly Windows

This heatmap displays the ten most influential features at each time step.
Lighter cells indicate higher feature importance; darker cells represent weaker SHAP contribution.

<p align="center"> <img src="images/explain_topk_heatmap.png" width="85%"> </p>


3) Complete Explainability Dashboard (Anomaly Score + SHAP Importance)

The final dashboard combines the LSTM anomaly score timeline with the real-time SHAP heatmap and the ranked Top-K feature panel.
This gives operators an immediate view of when anomalies occur and which sensors cause them.

<p align="center"> <img src="images/explain_full_dashboard.png" width="90%"> </p>
